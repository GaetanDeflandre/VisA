...
public class Dave_Visa_ implements PlugIn {
	...
	public void run(String arg) {
		...
		ImagePlus impseg;
		ImagePlus impJ;
		IJ.showMessage("Dave's Algorithme", "If ready, Press OK");
		ImagePlus cw;
		...
		impseg = NewImage.createImage("Image segmentee par Dave", width,
				height, 1, 24, 0);
		...
		Plot plot = new Plot("Performance Index (Dave)", "iterations",
