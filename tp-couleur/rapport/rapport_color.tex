...
\begin{figure}[H]
  \begin{center}  
    ...
    \shortstack{
      \includegraphics[width=120px]{images/it2_72pp_gris.png} \\ 
...
% Q2 comme image enregisté en RGVn qu'on ne conserve pas la tainte, 
% on ne peut pas retrouvé original à partir de gris
